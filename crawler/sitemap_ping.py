...
WP_URL = os.getenv('WP_URL', 'https://noinjob.kr')
...
def ping_naver():
    try:
        ...
        print(f'[네이버] 사이트맵 ping 완료 (status: {res.status_code})')
...
def ping_google():
    try:
        ...
        print(f'[구글] 사이트맵 ping 완료 (status: {res.status_code})')
    except Exception as e:
